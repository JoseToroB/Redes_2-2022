...
def toArray(signal):
    ...
    for i in range(0,len(signal)):
        new_signal.append(signal[i][0])
        new_signal.append(signal[i][1])
    return new_signal
...
frequencyB, signalB = read("jose_toro.wav")  # signalB for jose
'''
...
signalA = toArray(signalA)
signalB = toArray(signalB)
